...
const navItems = [
  ...
  { path: '/daily-workflow', label: '日频闭环', icon: 'M4 7h6V4H4v3Zm10 0h6V4h-6v3ZM4 20h6v-3H4v3Zm10 0h6v-3h-6v3ZM10 6h4m-1 0v11m-3-8h3m-3 2h3' },
...
@media (max-width: 820px) {
  ...
  .nav-list { display: grid; height: 100%; grid-template-columns: repeat(10, minmax(0, 1fr)); gap: 1px; }
  .nav-item {
    min-width: 0;
    min-height: 0;
    flex-direction: column;
