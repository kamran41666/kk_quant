...
from server.api import strategies, backtest, market, analytics, paper, observations, live, sandbox, factor_research, manual_trading, manual_workflow
...
app.include_router(manual_workflow.router, prefix="/api/v1")
