...
from server.models.schema import DailyDecision, ManualExecutionAuthorization, StrategyRelease, manual_now_str, uuid4_str
...
def create_daily_decision(
    ...
    *,
    ...
    row = DailyDecision(
        ...
        signal_date=signal_date.isoformat(), revision=revision, data_as_of=_timestamp(data_as_of),
